...
// TODO: FIXME: rewrite this all, because grishka did some things in appkit and now we need to redo stuff here
...
//					session.domain, true);
			if(emojiKeyboard!=null) emojiKeyboard.setListener(this);
			space.setVisibility(View.GONE);
			if(emojiKeyboard!=null) root.addView(emojiKeyboard.getView());
