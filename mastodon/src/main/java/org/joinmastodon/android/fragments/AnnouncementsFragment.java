...
public class AnnouncementsFragment extends BaseStatusListFragment<Announcement> {
	...
	protected List<StatusDisplayItem> buildDisplayItems(Announcement a) {
		...
		TextStatusDisplayItem textItem = new TextStatusDisplayItem(a.id, HtmlParser.parse(a.content, a.emojis, a.mentions, a.tags, accountID, fakeStatus, getContext()), this, getContext(), fakeStatus, accountID);
