...
public abstract class GithubSelfUpdater{
	...
	public static boolean needSelfUpdating(){
		return BuildConfig.BUILD_TYPE.equals("release") || BuildConfig.BUILD_TYPE.equals("githubRelease") || BuildConfig.BUILD_TYPE.equals("githubDebug") /* MOSHIDON */ || BuildConfig.BUILD_TYPE.equals("nightly");
	}
