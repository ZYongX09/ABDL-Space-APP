...
package org.joinmastodon.android.ui.compose.navigation.animation
...
internal class DampedDragAnimation(
    ...
    val onClick: DampedDragAnimation.() -> Unit,
    val onLongClick: DampedDragAnimation.() -> Unit,
    ...
    val modifier: Modifier = Modifier.pointerInput(Unit) {
        inspectDragGestures(
            ...
            onGestureEnd = { dragged, longPress ->
                when {
                    dragged -> onDragStopped()
...
internal suspend fun PointerInputScope.inspectDragGestures(
    ...
    onGestureEnd: (dragged: Boolean, longPress: Boolean) -> Unit = { _, _ -> },
    onDragCancel: () -> Unit = {},
    ...
    awaitEachGesture {
        ...
        val upEvent = drag(
            ...
            onDrag = {
                ...
                totalDrag += delta
                if (!dragged && totalDrag.getDistance() >= touchSlop)
                    dragged = true
                if (dragged)
                    onDrag(it, delta)
            },
        ...
        if (upEvent == null) {
            ...
            onGestureEnd(dragged, !dragged && upEvent.uptimeMillis - down.uptimeMillis >= longPressTimeout)
        }
    }
}
